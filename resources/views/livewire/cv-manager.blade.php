                                    ...
                                    @if (in_array('work_experience', $activeSections))
                                        <div class="border p-4 rounded bg-gray-50">
                                            <div class="flex justify-between items-center mb-2">
                                                ...
                                                <button wire:click="removeSection('work_experience')" class="text-red-500">Eliminar sección</button>
                                            </div>
                                            @foreach ($workExperiences as $index => $item)
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                                                    <input wire:model="workExperiences.{{ $index }}.company" placeholder="Empresa" class="form-input">
                                                    <input wire:model="workExperiences.{{ $index }}.position" placeholder="Puesto" class="form-input">
                                                    <input wire:model="workExperiences.{{ $index }}.start" placeholder="Inicio" class="form-input">
                                                    <input wire:model="workExperiences.{{ $index }}.end" placeholder="Fin" class="form-input">
                                                    <textarea wire:model="workExperiences.{{ $index }}.description" placeholder="Descripción" class="form-textarea md:col-span-2"></textarea>
                                                </div>
                                                <button wire:click="removeEntry('work_experience', {{ $index }})" class="text-red-500 text-sm mb-2">Eliminar experiencia</button>
                                            @endforeach
                                            <button wire:click="addEntry('work_experience')" class="bg-blue-500 text-white px-3 py-1 rounded">+ Añadir experiencia</button>
                                        </div>
                                    @endif
                                    ...
                                    @if (in_array('education', $activeSections))
                                        <div class="border p-4 rounded bg-gray-50">
                                            <div class="flex justify-between items-center mb-2">
                                                ...
                                                <button wire:click="removeSection('education')" class="text-red-500">Eliminar sección</button>
                                            </div>
                                            @foreach ($educations as $index => $item)
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                                                    <input wire:model="educations.{{ $index }}.school" placeholder="Centro educativo" class="form-input">
                                                    <input wire:model="educations.{{ $index }}.degree" placeholder="Título" class="form-input">
                                                    <input wire:model="educations.{{ $index }}.start" placeholder="Inicio" class="form-input">
                                                    <input wire:model="educations.{{ $index }}.end" placeholder="Fin" class="form-input">
                                                    <textarea wire:model="educations.{{ $index }}.description" placeholder="Descripción" class="form-textarea md:col-span-2"></textarea>
                                                </div>
                                                <button wire:click="removeEntry('education', {{ $index }})" class="text-red-500 text-sm mb-2">Eliminar educación</button>
                                            @endforeach
                                            <button wire:click="addEntry('education')" class="bg-blue-500 text-white px-3 py-1 rounded">+ Añadir educación</button>
                                        </div>
                                    @endif
                                    ...
                                    @if (in_array('languages', $activeSections))
                                        <div class="border p-4 rounded bg-gray-50">
                                            <div class="flex justify-between items-center mb-2">
                                                ...
                                                <button wire:click="removeSection('languages')" class="text-red-500">Eliminar sección</button>
                                            </div>
                                            @foreach ($languages as $index => $item)
                                                <div class="flex items-center space-x-2 mb-2">
                                                    <input wire:model="languages.{{ $index }}.language" placeholder="Idioma" class="form-input w-1/2">
                                                    <input wire:model="languages.{{ $index }}.level" placeholder="Nivel" class="form-input w-1/2">
                                                    <button wire:click="removeEntry('languages', {{ $index }})" class="text-red-500">✕</button>
                                                </div>
                                            @endforeach
                                            <button wire:click="addEntry('languages')" class="bg-blue-500 text-white px-3 py-1 rounded">+ Añadir idioma</button>
                                        </div>
                                    @endif
                                    ...
                                    @if (in_array('skills', $activeSections))
                                        <div class="border p-4 rounded bg-gray-50">
                                            <div class="flex justify-between items-center mb-2">
                                                ...
                                                <button wire:click="removeSection('skills')" class="text-red-500">Eliminar sección</button>
                                            </div>
                                            @foreach ($skills as $index => $item)
                                                <div class="flex items-center space-x-2 mb-2">
                                                    <input wire:model="skills.{{ $index }}.name" placeholder="Habilidad" class="form-input w-1/2">
                                                    <input wire:model="skills.{{ $index }}.level" placeholder="Nivel" class="form-input w-1/2">
                                                    <button wire:click="removeEntry('skills', {{ $index }})" class="text-red-500">✕</button>
                                                </div>
                                            @endforeach
                                            <button wire:click="addEntry('skills')" class="bg-blue-500 text-white px-3 py-1 rounded">+ Añadir habilidad</button>
                                        </div>
                                    @endif
                                </div>
